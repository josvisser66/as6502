...
extern void fnsplit(const char *filename, char*drive, char*dir, char*file, char*ext);
extern void fnmerge(char *filename, char*drive, char*dir, char*file, char*ext);
